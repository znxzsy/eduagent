...
- **决策分支**：学术路线（深入学习）、实践路线（应用探索）
- **技能体系**：学术能力 × 认知能力 × 社交能力 × 实践能力
- **攻守对抗**：攻击方 (噪声/逻辑) ↔ 防守方 (检测/缓解)

### 人类技能体系

![人类技能体系](docs/skill_tree_v2.png)

**4 大维度**：
- 📚 **学术能力**：语言能力、数学能力、科学素养、人文素养
- 🧩 **认知能力**：记忆力、注意力、推理能力、元认知
- 🤝 **社交能力**：沟通能力、协作能力、共情能力、冲突解决
- 🛠️ **实践能力**：问题解决、创造力、时间管理、适应力
...
1. **运气因子（~10%）**：承认考试中蒙对选择题等随机因素，但不主导评估
2. **知识点匹配评估**：核心是判断学生掌握度与题目知识点的匹配程度
3. **变形式验证（防背题）**：同一知识点多道变式题，防止题海战术背题
4. **真理解 vs 假理解**：不懂装懂/背题行为在轨迹中不会通过

**流程**：数据采集 → 轨迹编码 (SAR) → 质量评估 (运气/知识点/变式) → 数据存储 + 知识追踪 (IRT/BKT) → 批改优化

### 学习成长决策树

![学习成长决策树](docs/life_decision_tree_v2.png)

**6 阶段**：启蒙期 (3-6 岁) → 基础期 (6-12 岁) → 发展期 (12-15 岁) → 深化期 (15-18 岁) → 专业期 (18-22 岁) → 实践期 (22-60 岁) + 评估反馈闭环
...
- `skill_tree_v2.png` - 人类技能体系 (4 维度)
- `life_decision_tree_v2.png` - 学习成长决策树 (6 阶段)
- `sandbox_flow_v2.png` - 人生沙盒核心流程
